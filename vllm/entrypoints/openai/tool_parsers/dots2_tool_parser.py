...
@ToolParserManager.register_module("dots2")
class Dots2ToolParser(ToolParser):
    ...
    def __init__(self, tokenizer: AnyTokenizer):
        ...
        if isinstance(self.model_tokenizer, MistralTokenizer):
            ...
            self.model_tokenizer: AnyTokenizer = self.model_tokenizer.tokenizer
        ...
        self.tool_call_start_token: str = "<dots_function_call>"
        self.tool_call_end_token: str = "</dots_function_call>"

        self.tool_call_regex = re.compile(
            r"<dots_function_call>(.*?)</dots_function_call>|<dots_function_call>(.*)",
            re.DOTALL)
    ...
    def extract_tool_calls(
        ...
        if self.tool_call_start_token not in model_output:
            ...
            try:
                ...
                # Only include content if it has non-whitespace characters
                if content.strip():
